...
This project is indexed by GitNexus as **super-simple-shopify** (335 symbols, 443 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
