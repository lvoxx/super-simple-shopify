...
This project is indexed by GitNexus as **super-simple-shopify** (487 symbols, 708 relationships, 17 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
