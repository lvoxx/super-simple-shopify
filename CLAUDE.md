...
This project is indexed by GitNexus as **super-simple-shopify** (812 symbols, 1345 relationships, 39 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
